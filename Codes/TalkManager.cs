...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        talkData.Add("Talk1", new string[] {"안녕? 나는 콩딩이라고 해!", "나는 다른 콩들과 같이 콩깍지 속에서 평화롭게 살고있었어.", "그런데 그만 거대둘기마왕이 만든 회오리 바람에 의해 친구들이 다 날라가버렸어!", "친구들이 날 도와줘!", "난 지금 int타입이야! int타입의 장애물이 아니면 부술 수 없어~", "대쉬를 통해서 장애물을 부수면서 나아가도록하자!", "부술 수 있는 장애물 위에는 숫자나 글자가 쓰여있어!"});    
    }
